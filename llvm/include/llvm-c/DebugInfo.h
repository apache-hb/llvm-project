 ...
 */
LLVM_C_SYMBOL unsigned LLVMDebugMetadataVersion(void);

/**
 * The version of debug metadata that's present in the provided \c Module.
 */
LLVM_C_SYMBOL unsigned LLVMGetModuleDebugMetadataVersion(LLVMModuleRef Module);
 ...
 */
LLVM_C_SYMBOL LLVMBool LLVMStripModuleDebugInfo(LLVMModuleRef Module);

/**
 * Construct a builder for a module, and do not allow for unresolved nodes
 * attached to the module.
 */
LLVM_C_SYMBOL LLVMDIBuilderRef LLVMCreateDIBuilderDisallowUnresolved(LLVMModuleRef M);
 ...
 */
LLVM_C_SYMBOL LLVMDIBuilderRef LLVMCreateDIBuilder(LLVMModuleRef M);

/**
 * Deallocates the \c DIBuilder and everything it owns.
 * @note You must call \c LLVMDIBuilderFinalize before this
 */
LLVM_C_SYMBOL void LLVMDisposeDIBuilder(LLVMDIBuilderRef Builder);

/**
 * Construct any deferred debug info descriptors.
 */
LLVM_C_SYMBOL void LLVMDIBuilderFinalize(LLVMDIBuilderRef Builder);

/**
 * Finalize a specific subprogram.
 * No new variables may be added to this subprogram afterwards.
 */
LLVM_C_SYMBOL void LLVMDIBuilderFinalizeSubprogram(LLVMDIBuilderRef Builder,
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateCompileUnit(
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateFunction(
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateLexicalBlock(
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateImportedModuleFromAlias(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope,
 ...
 * \param NumElements    Number of renamed elements.
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateImportedModuleFromModule(
 ...
 * \param NumElements    Number of renamed elements.
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateImportedDeclaration(
 ...
 */
LLVM_C_SYMBOL unsigned LLVMDILocationGetLine(LLVMMetadataRef Location);
 ...
 */
LLVM_C_SYMBOL unsigned LLVMDILocationGetColumn(LLVMMetadataRef Location);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDILocationGetScope(LLVMMetadataRef Location);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDILocationGetInlinedAt(LLVMMetadataRef Location);
 ...
 * @see DIScope::getFile()
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIScopeGetFile(LLVMMetadataRef Scope);
 ...
 */
LLVM_C_SYMBOL const char *LLVMDIFileGetDirectory(LLVMMetadataRef File, unsigned *Len);
 ...
 */
LLVM_C_SYMBOL const char *LLVMDIFileGetFilename(LLVMMetadataRef File, unsigned *Len);
 ...
 */
LLVM_C_SYMBOL const char *LLVMDIFileGetSource(LLVMMetadataRef File, unsigned *Len);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderGetOrCreateTypeArray(LLVMDIBuilderRef Builder,
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateMacro(LLVMDIBuilderRef Builder,
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateEnumerator(LLVMDIBuilderRef Builder,
                                              const char *Name, size_t NameLen,
                                              int64_t Value,
                                              LLVMBool IsUnsigned);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateEnumerationType(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateUnionType(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
    size_t NameLen, LLVMMetadataRef File, unsigned LineNumber,
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreatePointerType(
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateStructType(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
    size_t NameLen, LLVMMetadataRef File, unsigned LineNumber,
    uint64_t SizeInBits, uint32_t AlignInBits, LLVMDIFlags Flags,
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateMemberType(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateForwardDecl(
 ...
 * \param UniqueIdentifierLen Length of the unique identifier.
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateClassType(LLVMDIBuilderRef Builder,
 ...
 * @see DIType::getName()
 */
LLVM_C_SYMBOL const char *LLVMDITypeGetName(LLVMMetadataRef DType, size_t *Length);
 ...
 */
LLVM_C_SYMBOL uint64_t LLVMDITypeGetSizeInBits(LLVMMetadataRef DType);
 ...
 */
LLVM_C_SYMBOL uint64_t LLVMDITypeGetOffsetInBits(LLVMMetadataRef DType);
 ...
 */
LLVM_C_SYMBOL uint32_t LLVMDITypeGetAlignInBits(LLVMMetadataRef DType);
 ...
 * @see DIType::getLine()
 */
LLVM_C_SYMBOL unsigned LLVMDITypeGetLine(LLVMMetadataRef DType);
 ...
 * @see DIType::getFlags()
 */
LLVM_C_SYMBOL LLVMDIFlags LLVMDITypeGetFlags(LLVMMetadataRef DType);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderGetOrCreateSubrange(LLVMDIBuilderRef Builder,
                                                 int64_t LowerBound,
                                                 int64_t Count);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderGetOrCreateArray(LLVMDIBuilderRef Builder,
                                              LLVMMetadataRef *Data,
                                              size_t NumElements);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateExpression(LLVMDIBuilderRef Builder,
 ...
 *                    specified)
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateGlobalVariableExpression(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
 ...
 */
LLVM_C_SYMBOL uint16_t LLVMGetDINodeTag(LLVMMetadataRef MD);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIGlobalVariableExpressionGetVariable(LLVMMetadataRef GVE);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIGlobalVariableExpressionGetExpression(
    LLVMMetadataRef GVE);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIVariableGetFile(LLVMMetadataRef Var);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIVariableGetScope(LLVMMetadataRef Var);
 ...
 */
LLVM_C_SYMBOL unsigned LLVMDIVariableGetLine(LLVMMetadataRef Var);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMTemporaryMDNode(LLVMContextRef Ctx, LLVMMetadataRef *Data,
                                    size_t NumElements);
 ...
 */
LLVM_C_SYMBOL void LLVMDisposeTemporaryMDNode(LLVMMetadataRef TempNode);
 ...
 */
LLVM_C_SYMBOL void LLVMMetadataReplaceAllUsesWith(LLVMMetadataRef TempTargetMetadata,
 ...
 *                    specified)
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateTempGlobalVariableFwdDecl(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
 ...
 */
LLVM_C_SYMBOL LLVMDbgRecordRef
 ...
 * \param Instr       Instruction acting as a location for the new intrinsic.
 */
LLVM_C_SYMBOL LLVMValueRef LLVMDIBuilderInsertDeclareIntrinsicBefore(
 ...
 */
LLVM_C_SYMBOL LLVMDbgRecordRef LLVMDIBuilderInsertDeclareRecordBefore(
    LLVMDIBuilderRef Builder, LLVMValueRef Storage, LLVMMetadataRef VarInfo,
    LLVMMetadataRef Expr, LLVMMetadataRef DebugLoc, LLVMValueRef Instr);
 ...
 */
LLVM_C_SYMBOL LLVMDbgRecordRef LLVMDIBuilderInsertDeclareAtEnd(
    LLVMDIBuilderRef Builder, LLVMValueRef Storage, LLVMMetadataRef VarInfo,
 ...
 * \param Block       Basic block acting as a location for the new intrinsic.
 */
LLVM_C_SYMBOL LLVMValueRef LLVMDIBuilderInsertDeclareIntrinsicAtEnd(
    LLVMDIBuilderRef Builder, LLVMValueRef Storage, LLVMMetadataRef VarInfo,
    LLVMMetadataRef Expr, LLVMMetadataRef DebugLoc, LLVMBasicBlockRef Block);
/**
 * Soon to be deprecated.
 ...
 */
LLVM_C_SYMBOL LLVMDbgRecordRef LLVMDIBuilderInsertDeclareRecordAtEnd(
    LLVMDIBuilderRef Builder, LLVMValueRef Storage, LLVMMetadataRef VarInfo,
    LLVMMetadataRef Expr, LLVMMetadataRef DebugLoc, LLVMBasicBlockRef Block);
 ...
 * \param Instr       Instruction acting as a location for the new intrinsic.
 */
LLVM_C_SYMBOL LLVMValueRef LLVMDIBuilderInsertDbgValueIntrinsicBefore(
 ...
 * \param Instr       Instruction acting as a location for the new intrinsic.
 */
LLVM_C_SYMBOL LLVMDbgRecordRef LLVMDIBuilderInsertDbgValueRecordBefore(
    LLVMDIBuilderRef Builder, LLVMValueRef Val, LLVMMetadataRef VarInfo,
    LLVMMetadataRef Expr, LLVMMetadataRef DebugLoc, LLVMValueRef Instr);
 ...
 * \param Block       Basic block acting as a location for the new intrinsic.
 */
LLVM_C_SYMBOL LLVMDbgRecordRef LLVMDIBuilderInsertDbgValueAtEnd(
    LLVMDIBuilderRef Builder, LLVMValueRef Val, LLVMMetadataRef VarInfo,
    LLVMMetadataRef Expr, LLVMMetadataRef DebugLoc, LLVMBasicBlockRef Block);
/**
 * Soon to be deprecated.
 ...
 * \param Block       Basic block acting as a location for the new intrinsic.
 */
LLVM_C_SYMBOL LLVMValueRef LLVMDIBuilderInsertDbgValueIntrinsicAtEnd(
    LLVMDIBuilderRef Builder, LLVMValueRef Val, LLVMMetadataRef VarInfo,
    LLVMMetadataRef Expr, LLVMMetadataRef DebugLoc, LLVMBasicBlockRef Block);
/**
 * Soon to be deprecated.
 ...
 * \param Block       Basic block acting as a location for the new intrinsic.
 */
LLVM_C_SYMBOL LLVMDbgRecordRef LLVMDIBuilderInsertDbgValueRecordAtEnd(
    LLVMDIBuilderRef Builder, LLVMValueRef Val, LLVMMetadataRef VarInfo,
    LLVMMetadataRef Expr, LLVMMetadataRef DebugLoc, LLVMBasicBlockRef Block);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateAutoVariable(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
 ...
 * \param Flags           Flags.
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMDIBuilderCreateParameterVariable(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMGetSubprogram(LLVMValueRef Func);
 ...
 */
LLVM_C_SYMBOL void LLVMSetSubprogram(LLVMValueRef Func, LLVMMetadataRef SP);
 ...
 */
LLVM_C_SYMBOL unsigned LLVMDISubprogramGetLine(LLVMMetadataRef Subprogram);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataRef LLVMInstructionGetDebugLoc(LLVMValueRef Inst);
 ...
 */
LLVM_C_SYMBOL void LLVMInstructionSetDebugLoc(LLVMValueRef Inst, LLVMMetadataRef Loc);
 ...
 */
LLVM_C_SYMBOL LLVMMetadataKind LLVMGetMetadataKind(LLVMMetadataRef Metadata);
